...
namespace CementBatchng
{
    public partial class Form1 : Form
    {
        ...
        private void Save__Recipe_Click(object sender, EventArgs e)
        {
            ...
            if (numericUpDown44.Value != 0 && numericUpDown44 != null)
            {
                double two = (decimal.ToDouble(numericUpDown31.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown44.Value) * cubeweight;
                double three = (decimal.ToDouble(numericUpDown32.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown44.Value) * cubeweight;
                double four = (decimal.ToDouble(numericUpDown33.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown44.Value) * cubeweight;
                double five = (decimal.ToDouble(numericUpDown34.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown44.Value) * cubeweight;
                double six = (decimal.ToDouble(numericUpDown35.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown44.Value) * cubeweight;
                double seven = (decimal.ToDouble(numericUpDown36.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown44.Value) * cubeweight;
                double eight = (decimal.ToDouble(numericUpDown37.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown44.Value) * cubeweight;
                double nine = (decimal.ToDouble(numericUpDown38.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown44.Value) * cubeweight;
                double ten = (decimal.ToDouble(numericUpDown39.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown44.Value) * cubeweight;
                double eleven = (decimal.ToDouble(numericUpDown40.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown44.Value) * cubeweight;
                double twelve = (decimal.ToDouble(numericUpDown41.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown44.Value) * cubeweight;
                double thirteen = (decimal.ToDouble(numericUpDown42.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown44.Value) * cubeweight;
                double fourteen = (decimal.ToDouble(numericUpDown43.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown44.Value) * cubeweight;
        ...
        private void Add__Order_Click(object sender, EventArgs e)
        {
            ...
            double initialTotal = decimal.ToDouble(numericUpDown17.Value + numericUpDown18.Value + numericUpDown19.Value + numericUpDown20.Value + numericUpDown21.Value + numericUpDown22.Value + numericUpDown23.Value + numericUpDown24.Value + numericUpDown25.Value + numericUpDown26.Value + numericUpDown27.Value + numericUpDown28.Value + numericUpDown29.Value);
            if (numericUpDown30.Value > 0)
            {
                double two = (decimal.ToDouble(numericUpDown17.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown30.Value) * cubeweight;
                double three = (decimal.ToDouble(numericUpDown18.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown30.Value) * cubeweight;
                double four = (decimal.ToDouble(numericUpDown19.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown30.Value) * cubeweight;
                double five = (decimal.ToDouble(numericUpDown20.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown30.Value) * cubeweight;
                double six = (decimal.ToDouble(numericUpDown21.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown30.Value) * cubeweight;
                double seven = (decimal.ToDouble(numericUpDown22.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown30.Value) * cubeweight;
                double eight = (decimal.ToDouble(numericUpDown23.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown30.Value) * cubeweight;
                double nine = (decimal.ToDouble(numericUpDown24.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown30.Value) * cubeweight;
                double ten = (decimal.ToDouble(numericUpDown25.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown30.Value) * cubeweight;
                double eleven = (decimal.ToDouble(numericUpDown26.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown30.Value) * cubeweight;
                double twelve = (decimal.ToDouble(numericUpDown27.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown30.Value) * cubeweight;
                double thirteen = (decimal.ToDouble(numericUpDown28.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown30.Value) * cubeweight;
                double fourteen = (decimal.ToDouble(numericUpDown29.Value) / (initialTotal)) * decimal.ToDouble(numericUpDown30.Value) * cubeweight;


                numericUpDown17.Value = Convert.ToDecimal(two);
                numericUpDown18.Value = Convert.ToDecimal(three);
                numericUpDown19.Value = Convert.ToDecimal(four);
                numericUpDown20.Value = Convert.ToDecimal(five);
                numericUpDown21.Value = Convert.ToDecimal(six);
                numericUpDown22.Value = Convert.ToDecimal(seven);
                numericUpDown23.Value = Convert.ToDecimal(eight);
                numericUpDown24.Value = Convert.ToDecimal(nine);
                numericUpDown25.Value = Convert.ToDecimal(ten);
                numericUpDown26.Value = Convert.ToDecimal(eleven);
                numericUpDown27.Value = Convert.ToDecimal(twelve);
                numericUpDown28.Value = Convert.ToDecimal(thirteen);
                numericUpDown29.Value = Convert.ToDecimal(fourteen);
        ...
        private void Send_To_Plc_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            orderDataAdapter = new SqlDataAdapter("SELECT * FROM OrderTable ORDER BY OrderId DESC", con);
            ...
            int orderId = Convert.ToInt32(oDataTable.Rows[0]["OrderId"]);
            //int destination = Convert.ToInt32(oDataTable.Rows[0]["OrderQuantity"]);
            double orderSize = Convert.ToDouble(oDataTable.Rows[0]["OrderQuantity"]);
            double Agg1 = Convert.ToDouble(oDataTable.Rows[0]["Agg1TargetWeight"]);
            double Agg2 = Convert.ToDouble(oDataTable.Rows[0]["Agg2TargetWeight"]);
            double Agg3 = Convert.ToDouble(oDataTable.Rows[0]["Agg3TargetWeight"]);
            double Agg4 = Convert.ToDouble(oDataTable.Rows[0]["Agg4TargetWeight"]);
            double Cement1 = Convert.ToDouble(oDataTable.Rows[0]["Cement1TargetWeight"]);
            double Cement2 = Convert.ToDouble(oDataTable.Rows[0]["Cement2TargetWeight"]);
            double Water = Convert.ToDouble(oDataTable.Rows[0]["WaterTargetWeight"]);
            double Add1 = Convert.ToDouble(oDataTable.Rows[0]["Additive1TargetWeight"]);
            double Add2 = Convert.ToDouble(oDataTable.Rows[0]["Additive2TargetWeight"]);
            double Add3 = Convert.ToDouble(oDataTable.Rows[0]["Additive3TargetWeight"]);
            double Add4 = Convert.ToDouble(oDataTable.Rows[0]["Additive4TargetWeight"]);
            int Wet = Convert.ToInt32(oDataTable.Rows[0]["TaregtWetMixTime"]);
            int Dry = Convert.ToInt32(oDataTable.Rows[0]["TargetDryMixTime"]);

            _S71500.Write("DB200.DBD2.0", orderId);
           // _S71500.Write("DB200.DBD4.0", orderId);
            _S71500.Write("DB200.DBD6.0", orderSize);
            _S71500.Write("DB200.DBD10.0", Agg1);
            _S71500.Write("DB200.DBD14.0", Agg2);
            _S71500.Write("DB200.DBD18.0", Agg3);
            _S71500.Write("DB200.DBD22.0", Agg4);
            _S71500.Write("DB200.DBD26.0", Cement1);
            _S71500.Write("DB200.DBD30.0", Cement2);
            _S71500.Write("DB200.DBD34.0", Water);
            _S71500.Write("DB200.DBD38.0", Add1);
            _S71500.Write("DB200.DBD42.0", Add2);
            _S71500.Write("DB200.DBD46.0", Add3);
            _S71500.Write("DB200.DBD50.0", Add4);
            _S71500.Write("DB200.DBD54.0", Dry);
            _S71500.Write("DB200.DBD58.0", Wet);
